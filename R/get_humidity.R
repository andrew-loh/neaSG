#' Gets per-minute relative humidity readings in Singapore for specified set of dates.
#'
...
#' @return Per-minute relative humidity readings in Singapore for various weather stations.
#' @examples
#' get_humidity("2017-12-31", "2018-01-04")
#' @export

get_humidity <- function(from, to) {
